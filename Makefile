build-ci:
	...
	cd bin
	tar cvzf signals-windows-amd64.tar.gz signals-windows-amd64.exe .env.local README
	tar cvzf signals-linux-amd64.tar.gz signals-linux-amd64 .env.local README
	tar cvzf signals-linux-arm64.tar.gz signals-linux-arm64 .env.local README
	tar cvzf signals-darwin-arm64.tar.gz signals-darwin-arm64 .env.local README